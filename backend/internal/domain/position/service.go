...
type PositionFilter = interfaces.PositionFilter

// PositionService is deprecated.
// Use interfaces.PositionService from internal/domain/interfaces/position_interfaces.go instead.
type PositionService = interfaces.PositionService
