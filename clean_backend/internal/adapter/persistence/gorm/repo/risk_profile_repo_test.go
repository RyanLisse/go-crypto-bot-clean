...
import (
	...
	. "github.com/RyanLisse/go-crypto-bot-clean/backend/internal/adapter/infrastructure/persistence/gorm/repo" // Use dot import
...
func TestGormRiskProfileRepository(t *testing.T) {
	...
	repository := NewGormRiskProfileRepository(db) // Use dot import alias
