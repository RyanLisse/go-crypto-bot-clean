...
func (m *MockMarketCache) CacheCandle(candle *model.Kline) {
	m.Called(candle)
}

func (m *MockMarketCache) GetCandle(ctx context.Context, exchange, symbol string, interval model.KlineInterval, openTime time.Time) (*model.Kline, bool) {
	args := m.Called(ctx, exchange, symbol, interval, openTime)
	if args.Get(0) == nil {
		return nil, args.Bool(1)
	}
	return args.Get(0).(*model.Kline), args.Bool(1)
}

func (m *MockMarketCache) GetLatestCandle(ctx context.Context, exchange, symbol string, interval model.KlineInterval) (*model.Kline, bool) {
...
func (m *MockMarketCache) CacheOrderBook(orderbook *model.OrderBook) {
	m.Called(orderbook)
}

func (m *MockMarketCache) GetOrderBook(ctx context.Context, exchange, symbol string) (*model.OrderBook, bool) {
	args := m.Called(ctx, exchange, symbol)
	if args.Get(0) == nil {
		return nil, args.Bool(1)
	}
	return args.Get(0).(*model.OrderBook), args.Bool(1)
}
...
func (w *mockMarketRepoWrapper) GetCandle(ctx context.Context, symbol, exchange string, interval model.KlineInterval, openTime time.Time) (*model.Kline, error) {
	return nil, nil
}

func (w *mockMarketRepoWrapper) GetCandleLegacy(ctx context.Context, symbol, exchange string, interval model.KlineInterval, openTime time.Time) (*model.Kline, error) {
	return nil, nil
}
...
func (w *mockMarketRepoWrapper) SaveCandle(ctx context.Context, candle *model.Kline) error {
	return nil
}

func (w *mockMarketRepoWrapper) SaveCandleLegacy(ctx context.Context, candle *model.Kline) error {
	return nil
}

func (w *mockMarketRepoWrapper) SaveCandles(ctx context.Context, candles []*model.Kline) error {
	return nil
}

func (w *mockMarketRepoWrapper) SaveCandlesLegacy(ctx context.Context, candles []*model.Kline) error {
	return nil
}

func (w *mockMarketRepoWrapper) GetCandles(ctx context.Context, symbol, exchange string, interval model.KlineInterval, start, end time.Time, limit int) ([]*model.Kline, error) {
	return nil, nil
}

func (w *mockMarketRepoWrapper) GetCandlesLegacy(ctx context.Context, symbol, exchange string, interval model.KlineInterval, start, end time.Time, limit int) ([]*model.Kline, error) {
	return nil, nil
}
...
func (w *mockMarketRepoWrapper) GetLatestCandle(ctx context.Context, symbol, exchange string, interval model.KlineInterval) (*model.Kline, error) {
	return nil, nil
}

func (w *mockMarketRepoWrapper) GetLatestCandleLegacy(ctx context.Context, symbol, exchange string, interval model.KlineInterval) (*model.Kline, error) {
	return nil, nil
}
...
func (w *mockMarketRepoWrapper) GetOrderBookLegacy(ctx context.Context, symbol, exchange string, depth int) (*model.OrderBook, error) {
	return &model.OrderBook{
		Symbol: symbol,
		Bids:   []model.OrderBookEntry{{Price: 49000.0, Quantity: 1.0}},
		Asks:   []model.OrderBookEntry{{Price: 51000.0, Quantity: 1.0}},
